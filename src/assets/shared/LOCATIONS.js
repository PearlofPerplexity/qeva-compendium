                ...
                topics: [
                    {
                        ...
                        name: `Breaking from Qeṽa`,
                        year: `84 D.E.`,
                        description: `When the first blood was split, not all of Moriel's creation had taken up arms and traveled west. Some women and children remained in the canyon of Akukar. Now the splitting of Qeva affected Baroach more than any other region as its earth was dry and brittle. When Qeva split, the canyon of Akukar expanded and a crack eclipsed the entire continent that departed. But not all of the bare lands were taken and the community of orcs remaining in Shaole was ripped apart. Some fell on the side of Avlim while many were sunk into the sea or trapped in the flooded caves of Akukar. But a select few of orc, hobgoblin and goblin children managed to escape on the side of Baroach.`
                    },
                    {
                        id: 1,
                    ...
                    },
                    {
                        ...
                        year: `84 D.E.`,
                        description: `One of the most dangerous animals for the Ohri children to come upon in Baroach was the raptor. It was about the size of a small horse and was highly intelligent. Unbeknownst to the Ohri or any for that matter, it respected the sentient people of Qeva and had no intention to make any of them a part of their diet. It is the reason why they drifted into the far easter lands. However, when orc and ohri came at the beasts throwing spears, they did defend themselves and often overcame raiding parties. They traveled in packs and were a dangerous beast to have as a foe in such a barren place, with few places to hide.`
                    },
                    {
                        id: 3,
