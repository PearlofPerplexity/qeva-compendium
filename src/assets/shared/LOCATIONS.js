                ...
                subtopics: [
                    {
                        ...
                        description: `Home to the most stubborn dwarves and original home of the oaki, Mhindilin was once a field on the eastern border of Nagar. However, upon the oaki genocide, DIA's tears have filled it and turned it into a swampy region, which is relatively unhabited besides its mountains to the north.`,
                        image: barir,
                ...
                topics: [
                    {
                        ...
                        year: `84 D.E.`,
                        description: `At the first blood spilt of Dia special creation, the sentients, Qeṽa was split into five continents, the center of which was “Avlim.” To the south, fell the landmass that would be called Maluñe by the elves, as they were the only ones to know of its existence. Though most sentients were drawn to the center of Avlim at the darkening of the skies, there were yet elves all across Qeṽa as they were the most numerous race. Elves in the Evéndil forest witnessed the terrible split of Maluñe. For great and terrible it was to see the enormity of the earth's crust rise skyward and slap the waters into waves. Trees, arbora and elves alike were thrown from the ground to fall like stones to the seabed. They reported the event to their kin and some would set sail and even swim for Maluñe at the storming of Moriel's dark armies.`
                    },
                    {
                        id: 1,
                        name: `First Elves of Malunë`,
                        year: `84 D.E.`,
                        description: `Malune. There was no greater land in all of Qeṽa (outside the forest of Navenia). Maulne was a lush paradise. Arbora and elves shared the land as a hidden paradise during the events of Avlim. These arbora and elves would form a bond that would not be experienced by the arbora and elves in Avlim. The arbora took many forms from mushrooms to moss, evergreens, grass and shrubs. The Elves were well-acquainted with Dia's heart for plants and they cared for the trees with a great love; a love that was reciprocated by all the trees of Maluñe. The two seemed to draw love not only from each other, but from the crust of the earth. For it was in fact here that the elf, Amare would bury the gift of Dia, the pure cut diamond - the stone of love. Though Amare knew of Maluñe, he never spoke of it nor sought it out. Amare's heart of love urged him to remain in Avlim and spend millenia to labor unrewarded caring for hardened hearts, blinded by hate. The same gnomes and dwarves who spit in his face, and blamed the darkening skies on the elden - he bound their wounds, and gently carried their stones to the graves of Agate. Amare would be the sole elden who would wait to directly oppose Moriel and his successors of darkness. It was not until the turn of the age, at the age of darkness when Amare made such a choice. Until then, He could be found moving from village to village, serving, protecting and healing the races of Avlim.`
                    },
                    {
                        id: 2,
    ...
    },
    {
        ...
        topics: [
            ...
            },
            {
                ...
                climate: `Arid`,
                description: `Lands where the ocri children began to habitat in their separation from Avlim`,
                subtopics: [
                    {
                        id: 0,
                        ...
                        cities: `Uthaduhn`,
                        features: `Sea Caves`,
                        description: `The Sea Caves of Uthaduhn was the first home to the ocri children in their separation from Avlim. After the breaking of Qeṽa, the ocri moved inward and made their dwelling there till their exodus southward.`
                    },
                    {
                        id: 1,
                        name: `Caves of Untu`,
                        ...
                        cities: `Untu`,
                        features: `Dry Caves`,
                        description: `The Caves of Untu were another home to the ocri children, who broke away from the larger group of ocri children. They re-established the way of the orc which they remembered from their parents.`
                    },
                    {
                        id: 2,
                        name: `Oril`,
        ...
        hTopics: [
            {
                ...
                topics: [
                    ...
                    },
                    {
                        ...
                        year: `207 V.E.`,
                        description: `There was a time in the history of Avlim, where no one could attest to the whereabouts of Avlim. He seemed to disappear from the first shores. Many assumed that he had sailed to the sanctuary of the elves in Malune, but the elves knew better. Elves sailed what they deemed “often” in the context of eternal life and none had seen him. And that is because he was not there. In Amare's quest to seek the lost, he had seemed it right to find the remaining lands of Baroach. He was one of the few elden or of any elves to have traveled in the desert lands for few had seen the purpose in going there. But Amare saw purpose in all of Dia's creation and visited there. He even spent time with Moriel and his orcs or at least what Moriel allowed for him to see. He knew there were women and children orcs unaccounted for after the splitting of Qeṽa. As the loving husband of Mhindil, he spent a great deal of time with the oaki in the Arthadan fields before their onslaught. Being so close to the canyon of Akukar, they had heard rumors from the oaki of orcs angry and grieving over their missing women and children. After the finding of Ishka, the first ocrim in Avlim, Amare felt that he had no choice but to search for the Orc children. Perhaps apart from Moriel's watchful eye, he could grow them up in goodness and love. He sailed alone accompanied only by his oaki companion and a necklace to remind him of his love, Mhindil. He took a small boat across the sea. At night, he would use his lumination to freeze the water below his boat into an anchor. It was just the right size so that by morning, it would be a sliver that would delicately break off with a gentle hit of the paddle. One night, a storm would push him to the northward part of Baroach, for Dia did not intend for Amare to find the ocri right away. Amare spent many years alone in the desert, looking for signs of life. He had almost given up hope when he finally found them. Walking through the bottom of a canyon a raptor leapt down from the top of the canyon.  At a guttural sound, he was followed by others scrambling down the ravine ridden by ocri. Macaron hid in Amare's hood. The pack of riders blocked either side of the canyon with javelins drawn and though he was powerful enough to overcome them, Amare remained neutral with his hand off his weapon. The forward ocri shouted upward and back, “we have found one alone!” 
                        
                        As the rest of the pack approached, a leader emerged from the group. He studied him carefully circling him with the raptor hissing uncomfortably close to his face. An ocrim from the pack quietly remarked “He is not like the rest...” The leader questioned Amare, “what are you and what is your business here?” Amare knelt before them, bowed his head and spoke softly, I am Amare, elden of Dia. I have been searching for you.” The leader dismounted. “We know nothing of what you speak.” At this, Amare lifted his gaze upon the leader and stood up slowly locking his hands behind his back. As he did, he divinely unsheathed his sword and placed its grip in the leader's hand. Softly he said, “There is much of the world that you do not know.” At this Amare gained their trust and he joined an ocrim rider atop a raptor as they rode for the caves of Uthaduhn. Over a warm fire, Amare told them the story of Dia and of the beginning of the world. He told them of elves, halflings, arbora, gnomes and dwarves. He spoke carefully about their creator, Moriel and the orc history. Amare remained with them and taught them in the ways of love, selflessness and humility. The ocrim took a liking to Macaron and made attempts to learn his language, for the vocal chords of the oaki did not allow their race to speak common. He guided them to the southern forests of Brioke where Dia's attributes were more lush, but this would not be their home for long.`
                    },
                    {
                        id: 8,
                        name: `War with the Red Gnomes`,
                        year: `310 V.E.`,
                        description: `The ocri were not the only ones to inhabit Baroach. Soon members of the traveling guilds sailed to bring order back to this parcel of Dia. But the years of separation from the lush attributes of the first shores would twist these adventurers' hearts and what was once the enforcement of oracle rule, would become enforcement of their own. They had unintentionally followed in the footsteps of Moriel's logic of forcible peace. The men created their own rule and the gnomes followed. Gnomes who were originally shades of blue and green slowly took on a reddish color. They attributed it tp the red sands in Baroachn but it was truly caused bt something within. For they were not only distinct from other gnomes in color, but also in character. They were more irritable and unpredictable like the men they followed. Their rule originated in Caraduhl. It was not until they sailed to the lush southern forests of Brioke that they encountered the ocrim. Now the ocri were peaceable and were willing to share their newfound paradise, but the men did not share this sentiment. They saw the ocri as creatures of pure evil and quickly deduced that Amare had been twisted to evil desires like Moriel. They attacked the ocri and pushed them back out of the forest. Amare was wise and told the ocri that it was not the time to fight. Their women and children were unprotected. He guided them northward saying, “It is better to have peace in a humble house than to quarrel in prosperity.” They took the long journey back to the sea caves of Uthaduhn. On their way they were raided by both the evil men and gnomes as well as the orcs living on Baroach.`
                    },
                    {
                        id: 9,
                        name: `Arrival of Ithmaar`,
                        year: `0 M.E.`,
                        description: `When Ithmaar reached the shores of Baroach he was extremely vulnerable. His abdomen was wrapped, but bleeding profusely. He merely fell on his face and crawled on the sand when he reached the shore. He was not far inward from the shoreline when he found himself an observer of a battle. He recognized both sides and their races: orcs against men and gnomes. Assuming the orcs were on his side, he joins them in battle making quick work of the men and gnomes. As the battle ends, the lead ocrim approaches Ithmaar saying, “Dia bless you, brother. By what grace are we visited by an Aviame? Ithmaar was shocked for several reasons. First, these orcs seemed civilized and dedicated to Dia. In Avlim, this meant a commitment to love and wisdom in a way the dark armies did not condone. Second, they referred to him as an Aviame. They seemed to have no knowledge about his existence or the history of the Athmari and his reign during the age of darkness. He paused and responded, “By Dia's grace, my friends.” They seemed pleased with this response and chuckled with an “Aye!” After this he asked, “What quarrel do you have with these men?” “They are evil men, friend. They seek to impress their peace by death and destruction. We are glad to have your aid…. What is your name, Aviame? “Ivar” he replied. “Well Ivar, anyone who fights beside me is a friend of mine. We would be honored if you would return to camp with us.” Intrigued, Ithmaar agreed. Upon arriving at camp he was shocked to see the elden, Amare sitting at a fire, but Amare did not see him at first. The ocri leader, Gallagher greeted Amare. “Amare, beloved. We came across Mavicks in the Avu Dunes. They were almost more than we could handle, but they have been swiftly handled” “We must not call them that, Gallagher.” Amare sighed and put his hand lovingly on the ocri's shoulder. “But I am glad you are alright.” 
                        
                        Suddenly, Amare noticed Ithmaar's presence and was equally as shocked. “Ithmaar.” Amare hid the oaki behind his back. Macaron hid under his shirt, digging his claws into Amare's back. “You mean Ivar, Gallagher said. “Only you, great Amare would believe the blessings of Dia. Amidst the skirmish, this Aviame appeared and aided us against our foes. “Is this so…” Amare said slowly. We would not all have made it back without him. I have seen none better with a sword.” Amare fumed with unusual anger for it was Ithmaar who had taken sport in killing his wife, Mhindil; making public display of her death and attempting genocide of the oaki. In a firm tone Amare says, “Explain yourself, Ithmaar of Rathank. Before Ithmaar could speak, Amare interjected again, “And why a thousand years and a league apart from Avlim, I should stay my blade from your neck.” Though unhelpful to the situation, Ithmaar wished to retort back that he was “Ithmaar of Arkrist” and that he had ruled the first shores for an age since last they met, but he withheld. “Most beloved brother of Dia, I am no longer that man.” I have changed. I have crossed Avlim from east to west making amends and my body shows the penalty I have paid.” He pulled his hand from the blood-soaked wraps around his abdomen. “I am now Ivar of Baroach. I sought these shores to repent in exile.” He knew that kneeling would sell the lie, but he could not bring himself to do it. He couldn't even muster a wince as an excuse. Amare, swallowed his anger and full of love, forgave. “I hope that this is so.” Amare turned to the ocri, “Do not be quick to trust, my brothers, I assure you this Aviame is capable in far more ways than combat. But we will take him at his word for none of us are noble if we cannot forgive.” With that Amare walked away. “Show him to the guest quarters. Post the guard.” Amare returned to his chamber and pondered in solitude. Ithmaar followed the ocri and grinned.`
                    },
                    {
                        id: 10,
                        name: `Meddling of Ithmaar`,
                        year: `0 M.E.`,
                        description: `You could say that Ithmaar earned the ocri's trust over the next couple months, but their trust was already earned at the first encounter. It was Amare whose trust grew in inches. With the ocri's complete trust, he began to spread his philosophies among them, those handed down by Moriel whenever Amare was away. Amare had not told them about Moriel to protect them. This gave Ithmaar the opportunity to craft the story. He described him as a savior of Avlim. A child of Dia bringing peace to the first shores of Qeṽa. Eventually he convinced them that they should make peace with their enemies as peace is the object of Dia. Thus, Ithmaar led the ocri in secret first to the encampment of the Orcs. “Awake my friends!” Ithmaar yelled. Lights flickered in their huts as armed orcs rushed toward them. In their pursuit, Ithmaar rose the earth beneath him into a platform. One orc shot an arrow at him and he swatted it away with lumination. Another arrow loosed and Ithmaar caught it in his hand. 
                        “Are you not the ones who recognize Moriel? As do we!” The orcs held their fire. “Then what do we have to fight about?”
                        With this, the orcs and ocri joined together and left for the encampment of men and gnomes in the lush region of Brioke. Together, they made an army that the Mavick men and gnomes could not stand against. They strode into Brioke with confidence as their opponents watched with horror. “Aren't you tired of fighting?” It received no response. “This land is ours now. All that is left is your answer. Will you be joining us?” They did.Meanwhile, Amare was in search of the ocri, who had disappeared from Uthaduhn. He was able to move throughout the land speedily unencumbered by companions. But he was too late. Before he could find them, he saw black smoke rising from Brioke. Ithmaar's forces had already settled in and were forging weapons and armor. When Amare arrived, the wood looked sick and the ocri like orcs.`
                    },
                    {
                        id: 11,
                        name: `Death of Amare`,
                        year: `20 M.E.`,
                        description: `“Ithmaar! show yourself!” Ithmaar walked casually into the clearing cleaning a blade with a dirty rag. “Amare. Greetings, heavenly brother.” “Gallagher, collect the others.” “But Amare, we have brought peace to Baroach. Why are you so angry?” “No, you have brought war.” Amare turned to Ithmaar. “What is your plan now, Ivar of Baroach? Will you bring “peace” to Baroach. Or will this not be enough. Will you also bring your “peace” to the first shores as well?” Amare lowered his arm to allow the oaki to crawl off of it and drew his sword. Ithmaar dropped his rag and divined a sword into his other hand. He twirled the two swords he was now dual-wielding. “I will not let you twist their minds, elden though you are, into believing that you bring peace by means of a sword.” Gallagher looked conflicted, but the battle ensued. Amare was the least trained for battle among the elden, but this was not saying much. He was a fair match for Ithmaar. They interlocked blades and Amare looked deep into Ithmaar's eyes. “By my blade or another's you will pay for the death of Mhindil, for the oaki, for the noble men, women and children of Avlim who have suffered by your hand, for the ocri children who have fallen under your curse!” Thei fight continued and Amare knocked Ithmaar from his feet, but the red gnomes were inspired by Ithmaar and used their inclination for magic to stun Amare with an illusory firework near his face. 
                        Ithmaar took the opportunity to kick Amare's knee and reverse the situation. Suddenly it was Amare who was on the ground with Ithmaar looming over head. Suddenly an ocri rushed forward. "Noooo!!!!" And another “Spare him, Ithmaar! Do we not fight for peace?” A few others followed behind, but Gallagher watched with trepidation. He was frozen and torn between his old friend and newfound hero. Ithmaar looked at the army encircling the duel. “He made his choice. He does not want peace.” With that, Ithmaar lifted his blade and brought it down on Amare beheading him. The dissenting ocri ran into the desert as a small band of men, orc and gnomes pursued them. The moment lasted forever for Gallagher; leader of the ocri and friend of Amare. Ithmaar reached down where the head had been liberated and held up a pendant with the sentient stone swinging at its end. Before he could secure it, He watched the stone pendant pull away from his grip and into the grubby hands of the oaki, Macaron, who vanished instantly. The body of Amare was given no grave. It lingered helplessly as rodents and birds unceremoniously carved it to bone.`
                    },
                    {
                        id: 12,
