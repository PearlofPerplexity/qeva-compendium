...
export const CLASSES = [
    ...
    },
    {
        ...
        //EQUIPMENT OPTIONS
        armor_options: ['Leather armor', 'Scale mail armor'],
        weapon_options: ['2 Shortswords', ...simpleWeapons],
        pack_options: ["Dungeoneer's pack", "Explorer's pack"],
        //PROFICIENCIES
        armor_prof: ["Light", "Medium"],
        weapon_prof: ["Shields", "Simple","Martial"],
        tool_prof: [],
        saving_throw_prof: ["Strength", "Constitution"],
        skill_prof_selection: ["Animal Handling", "Athletics", "Intimidation", "Nature", "Perception", "Survival"],
        skill_prof: [],
        skill_prof_num: 2,
    ...
    },
    {
        ...
        skill_prof_selection: ["Acrobatics", "Athletics", "History", "Insight", "Religion", "Stealth"],
        skill_prof: [],
        skill_prof_num: 2,
    ...
    },
    {
        ...
        skill_prof_selection: ["Animal Handling", "Acrobatics", "Nature", "Perception", "History"],
        skill_prof: [],
        skill_prof_num: 2,
    ...
    },
    {
        ...
        skill_prof_selection: ["Acrobatics", "Athletics", "Deception", "Insight", "Intimidation", "Investigation", "Perception", "Performance", "Persuasion", "Sleight of Hand", "Stealth"],
        skill_prof: [],
        skill_prof_num: 4,
    ...
    },
    {
        ...
        //EQUIPMENT OPTIONS
        armor_options: ['Chain mail armor', 'Leather armor'],
        ...
        tool_prof: [],
        saving_throw_prof: ["Dexterity"],
        skill_prof_selection: ["Nature", "Stealth", "Medicine", "History", "Investigation"],
        skill_prof: [],
        skill_prof_num: 2,
    ...
    },
    {
        ...
        tool_prof: [],
        saving_throw_prof: ["Strength", "Constitution"],
        skill_prof_selection: ["Animal Handling", "Athletics", "Investigation", "Perception"],
        skill_prof: [],
        skill_prof_num: 2,
        ...
        topics: [
            {
                ...
                name: `Adventurer`,
                quality: 'Lone Wolf',
                goal: `Your path is what you decide it to be`,
                race: ['Any'],
                expertise: `Varies`,
            ...
            },
            {
                ...
                skill_prof_selection: ["Arcana", "Deception", "Insight", "Intimidation", "Persuasion", "Religion"],
                skill_prof: [],
                skill_prof_num: 2,
                topics: [],
            ...
            },
            {
                ...
                name: `Bard`,
                quality: 'Performer',
                goal: `Perform throughout the land`,
                race: ['Any'],
                expertise: `Town Talk`,
            ...
            },
            {
                ...
                goal: `Study ahd harness the holistic powers of nature`,
                race: ['Any'],
                ...
                skill_prof_selection: ["History", "Insight", "Medicine", "Persuasion", "Religion"],
                skill_prof: [],
                skill_prof_num: 2,
                topics: [],
            ...
            },
            {
                ...
                skill_prof_selection: ["Arcana", "Animal Handling", "Insight", "Medicine", "Nature", "Perception", "Religion, Survival"],
                skill_prof: [],
                skill_prof_num: 2,
                topics: [],
            ...
            },
            {
                ...
                name: `Fighter`,
                quality: 'Combatant',
                goal: `Fight for money or for glory`,
                race: ['Any'],
                expertise: `Combat`,
                ...
                tool_prof: [],
                saving_throw_prof: ["Strength", "Constitution"],
                skill_prof_selection: ["Acrobatics", "Animal Handling", "Athletics", "History", "Insight", "Intimidation", "Perception", "Survival"],
                skill_prof: [],
                skill_prof_num: 2,
                topics: [],
            ...
            },
            {
                ...
                name: `Gemcutter`,
                quality: 'Jeweler',
                goal: `Handle and prepare the most delicate treasures of DIA`,
                race: ['Any'],
                expertise: `Gemstones`,
            ...
            },
            {
                ...
                name: `Scribe`,
                quality: 'Historian',
                goal: `Chronicle the deeds of the world`,
                race: ['Any'],
                expertise: `History`,
                ...
                saving_throw_prof: ["Intelligence", "Wisdom"],
                skill_prof_selection: ["History", "Medicine", "Nature", "Performance", "Persuasion", "Religion"],
                skill_prof: [],
                skill_prof_num: 2,
                topics: [],
