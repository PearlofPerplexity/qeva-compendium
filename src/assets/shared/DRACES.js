...
export const DRACES = [
    {
        ...
        government: 'Tyranny',
        residence: 'Shaöle',
        description: 'There are many creatures hidden in the veil of the east, but most well known among them is the orc. It seems to be of a natural evil if good-hearted ones were not fabled. Everything about them is horrid. From yellowed teeth, to oily hair, gray skin and filthy garments, they seem to have forgot any of the goodness they were created with. All wars of the past seem to be stirred up by them and the rest of the evil races known as the “dark armies.” Not much more is known about them and not much is desired to be known. It is a popular prayers to not run across such a beast in one&#39s life.',
        image: user
    },
    {
        id: 1,
