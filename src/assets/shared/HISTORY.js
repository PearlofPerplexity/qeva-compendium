export const HISTORY = [
    {
        id: 0,
        link: `/history/sparkling-age`,
        name: `Sparkling Age`,
        description: `The sparkling age encompasses the inception and shaping of the world before the first race of men were born.`,
        topics: [
            {
                id: 0,
    ...
    {
        id: 1,
        link: `/history/quintessential-age`,
        name: `Quintessential Age`,
        description: `The quintessential age is the age of Qeṽa at its best when the veil of the void was secure and DIA's qualities flourished throughout the world.`,
        topics: [
            {
                id: 0,
                name: `The Eveile`,
            ...
            },
            {
                id: 4,
                name: `Mortality`,
                description: `Nonetheless, DIA would not have Moriel suffer this error forever. HE gathered the eveile together and breathed into them mortality and vulnerability. He described pain and death and declared how it would now have power over them so that Moriel's error would not keep him from his soul eternally. The eveile would live longer than any of their kin and their kind would see every age to come in order that they might instruct those after them about the dangers of the void. DIA explained how they might use pain in these many years for good, but the eveile were too overcome by the news to hear it.  And so they became called the elden, for they were oldest of all sentients, last of the immortally born men and last of the invincibly born. Only one would live to see every age of Qeṽa before Agate above.`
            },
            {
                id: 5,
                name: `Vasia`,
    ...
    {
        id: 2,
        link: `/history/divergent-age`,
        name: `Divergent Age`,
        description: `The Divergent Age was marked by the creation of the different races, which led to the divergence of the eveile.`,
        topics: [
            {
                id: 0,
    ...
    {
        id: 3,
        link: `/history/void-age`,
        name: `Void Age`,
        description: `The Void Age was the darkest hour of Avlim when the dark Lord Ithmaar summoned void magic to drain Avlim of DIA's qualities in the world and the heart.`,
        topics: [
            {
                id: 0,
                name: `The Void`,
    ...
    {
        id: 4,
        link: `/history/mortal-age`,
        name: `Mortal Age`,
        description: `The mortal age began when DIA's Spirit filled a man and through this man cast out Ithmaar from Avlim. Because of this, the rule of Avlim was given to men`,
        topics: [
            {
                id: 0,
