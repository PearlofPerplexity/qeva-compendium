...
export const DIVINE = [
    {
        ...
        layers: [
            ...
            },
            {
                id: 3,
                name: 'Etherworld',
                description: 'The etherworld or ether is the home of the ethereals. It is the layer of heaven in which all ethereals live and disembodied souls are pulled. It will be abolished at the coming of agate above, when DIA removes moissanite from Qeva.'
            },
            {
                id: 4,
                name: 'Everworld',
            ...
            },
            {
                id: 5,
                name: 'The Void',
                description: 'The void is the absence of anything. A black hole is a rip between the heavens that gives a window into the immensity of this layer&#39s appetite. Dark sorcerers access this dangerous layer through a dark magic known as void magic, which voids a target of whatever the diviner chooses or is powerful enough to bring about.'
            },
        ]
    },
    {
        id: 1,
        link: '/divination-magic',
        ...
        topics: [
            ...
            },
            {
                ...
                description: 'Though Divination is the channeling of Dia&#39s Essence, it can be enhanced by the influence of ethereals. In fact, ethereals are most effective in exacting change in this way. It takes far greater energy for ethereals to enter the physical world through sight or speech than to work from within the ether. And if they should enter, they cannot channel DIA&#39s essence through divination in the physical form. Thus, an ethereal can influence a physical being by either empowering them with further essence from DIA or warding against wraiths.'
            }
        ]
    },
    {
        ...
        types: [
            ...
            },
            {
                ...
                alignment: 'Evil',
                form: 'Physical',
                description: 'Like wraiths, Reapers (Muerarayas) oppose goodness and DIA, but unlike wraiths they take a physical form. They often take this form out of impatience to ravage DIA&#39s creation in the ether and so are wild and savage when met, though some are able to subdue their bloodlust long enough to deceive. This being said, they prefer to take terrible shapes and even interbreed with orcs to create even more terrible creatures.',
                image: reaper
            },
            {
                id: 6,
            ...
            },
            {
                ...
                subtopics: [
                    ...
                    },
                    {
                        ...
                        description: 'The fate of the physical body is perhaps even more interesting than that of the soul. Throughout a physical person&#39s life, they are slowly undergoing the process of soul crystallization. What is this? Sitting in one&#39s chest beside the heart is an anatomical gem known as the soul chamber. It is the house of the soul. At the beginning of one&#39s life, the soul chamber is nought but moissanite and so is ethereal and invisible. However, as one goes through life and actions reveals their character, the moissanite sheds away and new, physical crystal structures harden in its place. If one does acts of kindness, emerald will grow in its place. If one commits acts of violence, bloodstone will grow. Rarely if ever does one&#39s soul chamber crystallize into one singular gem. Rather it is a spectrum of color from every deed done in life. In most cases, every gem will be present. Some may ask if they do not all look alike, but they do not. While it is a composite of a myriad of gems, they all fall into one recognizable gem structure. If a person&#39s life is most marked by patience, it will take the shape and structure of pyrite. If their defining quality is peace, it will form like amethyst. The longer a person lives, the harder it is for them to change and it is the same for ethereals.'
                    }
                ]
            },
            {
                id: 2,
                name: 'Moissanite',
                description: 'Moissanite is the stone of invisibility and divides the planes of existence. It is found in the air around us and the ethereals who dwell within it and every soul of every sentient ever created. It makes up DIA himself and HIS manifestation within the world. Active moissanite travels freely through space if not wrapped in the hands of a sentient, most often times an ethereal. However, if an ethereal abandons the quality of the moissanite and loiters too long in the etterworld, the heart of the gem will diminish and no longer travel freely. It will be bound by physics and be visible from the corner of one&#39s eye.',
                subtopics: [
                    {
                        id: 0,
                        name: 'The Parsing of Invisibility',
                        description: 'This stone was the cinder of hope to humanity in the age of darkness at the expense of DIA Himself. As black polluted clouds covered the entire planet, it seemed that all bonds with DIA were lost. On the islands, there were no mountains high enough for the people to speak with HIM and no way to rise above the smoke. To remain in communion with HIS people, the good and gracious DIA spared a cut of his true essence of invisibility and bestowed it upon Avlim. To the noble races, it appeared as a star falling from the sky in the form of pure moissanite, the stone of invisibility. After the moissanite passed through the atmosphere and cleared the smoke that plagued the sky, the falling star split into two: one being the forever-after visibility of DIA within the world and the second being an excess cut of moissanite not spent clearing the sky. If any would come across the excess moissanite, they would have the opportunity to mask their visibility. Stories of this are told in the records of Malune. With this event, the air that polluted the sky was cleansed. The atmosphere became clear across all of Qeṽa and the smoke of Moriel was contained to the hearts of his great forges.'
                    },
                    {
                        id: 1,
                        name: 'Moissanite and the End of the World',
                        description: 'As mentioned above, moissanite&#39s property of transmutation allows it to pass through time and space unbound. This makes it near impossible for an ethereal to recover once they have chosen physical form. However, it has an even greater impact on the world. As ethereals release moissanite by taking physical form and sentients likewise release the moissanite of their soul chambers throughout their life, gravity pulls these crystals toward the center of the world and the world grows increasingly invisible until the whole world ultimately becomes engulfed by it. Ironically, the witnessing of this growing invisibility in the very end quickens bloodshed and expedites the flow of moissanite into the world. Only then is the veil be pulled back and all planes of existence united in the endworld at agate above. Conversely, while moissanite grows stronger in the world, the physical gems grow weaker. This waning of gems allows the wraiths and other evils to enter into Avlim that used to be contained in outer continents.'
                    },
                    {
                        id: 2,
                        name: 'The Perifiworld',
                        description: 'At agate above, the moissanite causes the continents to float and the planet to warp. Ultimately, DIA reorients and rebuilds the world. He draws all stones, gems and crystals to Avlim, which becomes the heart of the world. However, not all come. The gems that do return are enlivened and create a lush, eternal paradise in the center of the world. The gems that do not return are repelled to the outer continents, which remain in eternal, climatic extremes of distress. These outer islands are called the perifiworld. Since the soul is immortal and cannot be destroyed, they also are either repelled or drawn to DIA. A soul in unity with DIA and HIS gems will be enlivened, while a sou in disunity with DIA and HIS gems is repelled to the outer islands. Those in disunity are at the same time drawn and repelled by DIA, which causes eternal pain.'
                    }
                ]
            },
            {
                ...
                subtopics: [
                    {
                        ...
                        description: 'When DIA created the elves, HE created the ethereals also in secret for the purpose of shepharding HIS creation. HE bore them out of the gem, moissanite, which is the gem of invisibility and in so doing placed them in the etherworld, an invisible layer in the heavens of Qeva. They were beautiful like the elves and their skin glowed like the everstar. This layer of reality could only be witnessed by pure goodness and without it the ethereals&#39 existence was beyond the curtain of fleshly eyes. The ethereals had free reign of the heavens and when they awoke, DIA sent them out to explore the universe and its many galaxies and planets. They did so with sweet songs and joy in their hearts. When the elves awoke, they were perfect and full of goodness and so when they looked into the sky, they saw the ethereals and confused them for stars flying wildly like fireflies deep in the night sky. To this day, there are some in Qeva who will look up into the night sky to test their heart of goodness and search for moving stars. What some call shooting stars as truly glimpses of the ethereals and the traces of deep goodness in one&#39s own heart.'
                    },
                    {
                        id: 1,
                        name: 'The Divine Counsel',
                        description: 'Spirits are not without organization. Below DIA is the Divine Counsel, which is the spiritual equivalent to the sentinels. Its individual members are known as Seraphs and they command the spiritual armies who march in DIA&#39s name.'
                    }
                ]
            },
            {
