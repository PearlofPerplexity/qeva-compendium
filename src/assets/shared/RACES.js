...
export const RACES = [
    {
        ...
        description: 'Elves were the first race to live in Qeva. They roamed the world and even the stars for a thousand years before the other races appeared. They are immortal therefore wisest of the races. They can be deciphered from men by their fair skin, and pointed ears. They are responsible for the cathedrals around Qeva mythed to be erected through divination and they are drawn to DIA&#39s attributes in water and wood.',
        subraces: [
            {
                id: 0,
                race: 'Wood Elves',
