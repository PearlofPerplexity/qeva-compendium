...
export const GEMS = [
    {
        ...
        gems: [
            ...
            },
            {
                ...
                name: 'Obsidian',
                quality: 'Solitude',
                purpose: 'Physical Manifestation of DIA&#39s Reflection',
            ...
            },
            {
                ...
                description:
                    'Tiger&#39s eye is a golden stone with black stripes and thus rightly earns its name. Since it is the stone of creativity, it draws intrigue and creative ideas about its true properties and purposes. Those who are superstitious believe it to be the stone of luck, while those who consider themselves holy consider it the stone of blessing. It&#39s true property, however, is creativity and naturally spurs this quality in those who seek it. Notably, it enables to practice soul flying in their REM sleep. However, without the stone of goodness, this soul-flying is often clouded by hallucinetic qualities. Thus, those who hold it, often have strange dreams or strange soul-flying experiences. It is a stone of divinity as all created sentient beings&#39 creativity relies on a previous source, while DIA&#39s does not.',
                image: tigersEye
            },
        ]
    },
    {
        ...
        gems: [
            ...
            },
            {
                ...
                description:
                    'There is then Amethyst, which is peace. It is purple in color and glitters even unpolished. This stone was opened by the dark lord, Moriel, to craft the races of the dark armies, but do not make the mistake to say that the stone is cursed. It is not in Amethyst&#39s nature to be destructive. You, Sentinel can restore honor to an Amethyst gem by allowing the stone to draw oneself and others to DIA rather than oneself. With Amethyst you will be the eye of the hurricane, the calm of the storm.',
                image: amethyst
            },
            {
                id: 3,
            ...
            },
            {
                ...
                description: 'Greatest and rarest of all cardinal stones is the pearl of humility. Consider yourself the lowliest and vilest of sentience before DIA if you wish for it not to crumble in your hand. For it is brittler than fine glass and is mere myth among the noble races. No eldar was entrusted with it and no dwarf has been known to recover it from stone. It is white, circular and smooth as the surface of Qeva before the sprinkling of DIA&#39s attributes. If ever you come across it, know this: the wielder of the pearl of humility is gifted with the attribute necessary to pursue and master all other attributes. However, the more one grows in the attributes, the more difficult this stone is to control, but the one who does will be among the most powerful warriors to walk Qeva.',
                image: pearl
            },
        ]
    },
        ...
        topics: [
            {
                ...
                description: 'Gemstones are living things like plants or animals and they require proper care to be kept alive. They are renowned for the abilties they grant, but they do not grant such abilities unwillingly. One must bind yourself to the property of the stone if they are to access its abilities. It is a mutual relationship of sacrifice. Only as much as one portrays the stone&#39s qualities will it yield itself to the person. If one gives themselves wholly to a stone&#39s attribute, they will receive power from the stone.',
                subtopics: [
                    {
                        id: 0,
                        name: 'Divine Stones',
