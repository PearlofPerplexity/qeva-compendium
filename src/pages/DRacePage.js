        ...
        <div className='py-2 px-3'>
            <Routes>
                ...
                <Route path='/orcs' element={
                    <SingRaceCard array={DRACES[0]} left={DRACES[5]} right={DRACES[1]} />
                } />
                ...
                <Route path='/mongrels' element={
                    <SingRaceCard array={DRACES[4]} left={DRACES[3]} right={DRACES[5]} />
                } />
                <Route path='/wraiths' element={
                    <SingRaceCard array={DRACES[5]} left={DRACES[4]} right={DRACES[0]} />
                } />
            </Routes>
        </div>
    );
