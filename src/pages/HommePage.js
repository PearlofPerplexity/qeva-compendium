            ...
            <div className="p-4">
                <div className="welcome">
                    <div className="content rounded-3 p-3">
                        ...
                        <p className="mb-0">Browse the options below or click on the hamburger icon in the top right hand corner to see the full menu. Or learn the basics <Link href="">here</Link>. May every blessing of DIA be upon you!</p>
                    </div>
                </div>
                ...
                <section className="highlights mt-4">
                    <div className="row">
                        <div className="col-lg-4 covered-div">
                            <Link href="gemstones/gems-overview.html" className="cover-link"></Link>
                        ...
                        <div className="col-lg-4 covered-div">
                            <Link href="races/elves.html" className="cover-link"></Link>
                            <div className="box d-flex rounded-2 align-items-center mb-4 mb-lg-0 p-3">
                        ...
                        <div className="col-lg-4 covered-div">
                            <Link href="classes/sentinels.html" className="cover-link"></Link>
                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="chart-container map-img rounded-2 p-3">
                                ...
                                <div className="overlay">
                                    <Link href="divination/divination-spiritual.html" className="cover-link"></Link>
                        ...
                        <div className="col-lg-6">
                            <div className="chart-container rounded-2 p-3">
                                ...
                                <div className="overlay">
                                    <Link href="races/aviame.html" className="cover-link"></Link>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-3">
                            <div className="box potential-box p-3">
                                <Link href="basics.html" className="cover-link"></Link>
